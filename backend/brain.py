...
def get_demo_match(username1: str, username2: str) -> dict:
    return DEMO_MATCHES.get((username1, username2), None)
...
if __name__ == "__main__":
    ...
    print("\n=== Match: yahya ↔ alice ===")
    print(json.dumps(find_build_matches(yahya, alice), indent=2, ensure_ascii=False))

    print("\n=== Match: yahya ↔ bob ===")
    print(json.dumps(find_build_matches(yahya, bob), indent=2, ensure_ascii=False))
